...
def seed_massive_crops(db: Session = Depends(get_db)):
    ...
    try:
        from models import Farmer, Product, ProductCategory, User, Booking, SavedProduct, NegotiationHistory, Report
        import random
        ...
        # 1. Clear existing products to prevent duplicates (with soft cleanup)
        try:
            db.query(Product).filter(Product.farmer_id == farmer.id, Product.name.like('%Lot #%')).delete(synchronize_session=False)
            db.flush()
        except:
            print("Soft delete of old lots failed, continuing with insertion.")
            db.rollback()
        ...
        crops_pool = [
            ...
            ("Mustard Seeds", "oilseeds", 55.0, "https://images.unsplash.com/photo-1511283626248-c800889988cc?w=800"),
            ...
            ("Moong Dal", "pulses", 110.0, "https://images.unsplash.com/photo-1626082927389-6cd097cdc6ec?w=800"),
            ("Arhar Dal", "pulses", 140.0, "https://images.unsplash.com/photo-1515942400420-2b98fed1f515?w=800"),
            ("Black Gram", "pulses", 125.0, "https://images.unsplash.com/photo-1594910413554-9457803e07f4?w=800"),
            ...
            ("Cardamom", "spices", 2500.0, "https://images.unsplash.com/photo-1634863202928-8686e580e03c?w=800"),
            ("Black Pepper", "spices", 450.0, "https://images.unsplash.com/photo-1532336414038-cf19250c5757?w=800"),
            ("Cloves", "spices", 900.0, "https://images.unsplash.com/photo-1610450949065-2f2231267803?w=800"),
        ]
